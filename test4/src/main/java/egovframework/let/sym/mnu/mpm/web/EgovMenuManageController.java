...
public class EgovMenuManageController {
	...
	public String selectMenuManageList(@ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model) throws Exception {
		...
		//[{menuNo=0, menuOrdr=1, menuNm=root, upperMenuId=0, menuDc=root, relateImagePath=/, relateImageNm=/, progrmFileNm=dir}, 
		//{menuNo=1000000, menuOrdr=1, menuNm=알림정보, upperMenuId=0, menuDc=알림정보, relateImagePath=/, relateImageNm=/, progrmFileNm=dir}, 
		//{menuNo=1010000, menuOrdr=1, menuNm=공지사항, upperMenuId=1000000, menuDc=공지사항, relateImagePath=/, relateImageNm=/, progrmFileNm=EgovInfoNotice}, 
		//{menuNo=1020000, menuOrdr=2, menuNm=업무게시판, upperMenuId=1000000, menuDc=업무게시판, relateImagePath=/, relateImageNm=/, progrmFileNm=EgovInfoWork}, 
		//{menuNo=2000000, menuOrdr=2, menuNm=직급체계관리, upperMenuId=0, menuDc=직급체계관리, relateImagePath=/, relateImageNm=/, progrmFileNm=dir}, 
		//{menuNo=2010000, menuOrdr=1, menuNm=입퇴사정보 관리, upperMenuId=2000000, menuDc=입퇴사정보 관리, relateImagePath=/, relateImageNm=/, progrmFileNm=EgovJoinHistory}, 
		//{menuNo=2020000, menuOrdr=2, menuNm=직급정보 관리, upperMenuId=2000000, menuDc=직급정보 관리, relateImagePath=/, relateImageNm=/, progrmFileNm=EgovMberRank}, 
		//{menuNo=2030000, menuOrdr=3, menuNm=직위정보 관리, upperMenuId=2000000, menuDc=직위정보 관리, relateImagePath=/, relateImageNm=/, progrmFileNm=EgovMberPositionl}, 
		//{menuNo=3000000, menuOrdr=3, menuNm=진급관리, upperMenuId=0, menuDc=진급관리, relateImagePath=/, relateImageNm=/, progrmFileNm=dir}, 
		//{menuNo=3010000, menuOrdr=1, menuNm=업무평가점수 관리, upperMenuId=3000000, menuDc=업무평가점수 관리, relateImagePath=/, relateImageNm=/, progrmFileNm=EgovWorkEstimation}]
